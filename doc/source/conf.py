# -*- coding: utf-8 -*-
#
# Connectome File Format Library documentation build configuration file, created by
...
sys.path.append(os.path.abspath('../../cfflib'))
...
htmlhelp_basename = 'ConnectomeFileFormatLibrarydoc'
